      ...
      <?php
       ...
       if(in_array("", $dados)){
        ...
        if(!$empty_input){
          ...
          $query_cliente = "INSERT INTO cliente (nome, dataNascimento, email, senha,cep,estado,bairro) VALUES ('".$dados['nome'] ."', '" .$dados['dataNascimento']. "',
        '" .$dados['email'] . "', '" .$senha . "', '" .$dados['cep'] . "', '" .$dados['estado'] . "','".$dados['bairro']. "') ";
            ...
            <body>
                ...
                <section class="area-cadastro">
                    <div class="cadastro">
                        ...
                        <form id="form1" name="cadCliente" method="POST" action="">
                            ...
                            <input type="submit"value="Criar conta" name= "cadCliente">
                        </form>
                        <br>
                        <p>Já tem uma conta?<a href="logincliente.php">Entrar</a></p>
