...
if(isset($_POST['email']) || isset($_POST['senha'])) {
    ...
    if(strlen($_POST['email']) == 0){
       echo "Preencha o seu email";
        ...
        $sql_code = "SELECT * FROM trabalhador WHERE email = '$email'  ";
        ...
        if($quantidade == 1) {
           ...
           if(password_verify($senha, $senhaArmazenada)){
            ...
            echo "<div class='erro1'>senha incorreta</div>";
            }

        } else {
            echo "<div class='erro2'>Conta não existe</div>";
        }
                ...
                <section class="area-cadastro">
                    <div class="cadastro">
                        ...
                        <form action="" method="POST">
                            ...
                            <input type="submit"value="LOGIN"><a href="cadastrotrabalhador.php"></a>
                        </form>
                        <br>
